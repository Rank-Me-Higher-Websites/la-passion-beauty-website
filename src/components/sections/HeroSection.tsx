  ...
  return (
    <section className="relative md:min-h-[85vh] md:flex md:items-center overflow-hidden">
      ...
      <div className="w-full relative z-10 pt-[48px] md:pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        {/* Mobile layout */}
        <div className="md:hidden min-h-[calc(100svh-48px)] flex flex-col justify-center py-4">
          <h1 className="text-2xl leading-tight font-serif font-semibold text-foreground mb-1">
            Chicago's Top-Rated{" "}
