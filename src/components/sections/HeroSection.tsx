        ...
        <div className="grid lg:grid-cols-5 gap-4 md:gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-3">
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-semibold leading-tight text-foreground mb-2 md:mb-6"
            >
              Chicago's Top-Rated{" "}
              <span className="text-primary italic">Beauty & Hair Salon</span>{" "}
              <span className="hidden sm:inline">in Lemont, IL</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-sm sm:text-lg md:text-2xl lg:text-3xl text-muted-foreground mb-2 md:mb-6 max-w-2xl font-light"
            >
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center gap-3 md:gap-6 mt-2 md:mt-8"
            >
              <div className="flex items-center gap-1 md:gap-2">
                ...
                <span className="text-xs md:text-sm font-semibold text-foreground">5.0</span>
              </div>
              <div className="flex items-center gap-1 md:gap-2">
              ...
              <a href="tel:+13313188113" className="md:hidden text-xs font-semibold text-primary ml-auto flex items-center gap-1">
