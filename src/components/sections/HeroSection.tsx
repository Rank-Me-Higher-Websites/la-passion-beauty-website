        ...
        <div className="grid lg:grid-cols-5 gap-4 md:gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-3 order-2 lg:order-1">
            <motion.h1
              ...
              className="hidden md:block text-4xl md:text-5xl lg:text-7xl font-serif font-semibold leading-tight text-foreground mb-3 md:mb-6"
            >
              Chicago's Top-Rated{" "}
            ...
            <motion.p
              ...
              className="hidden md:block text-2xl lg:text-3xl text-muted-foreground mb-3 md:mb-6 max-w-2xl font-light"
            >
                ...
                {services.map((service) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[10px] md:text-xs ${isActive ? "text-primary-foreground/80" : "text-muted-foreground"}`}>
                        {service.price}
                      </span>
                    </button>
                  );
